...
const BairroContactSection = ({ bairro }: BairroContactSectionProps) => {
  ...
  const onSubmit = async (data: ContactFormData) => {
    ...
    try {
      ...
      toast({ title: 'Erro ao enviar', description: 'Tente novamente ou entre em contato via WhatsApp.', variant: 'destructive' });
    } finally {
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4 font-heading">
            Contato - Assistência Técnica no {bairro}
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Envie sua mensagem do {bairro} e receba um orçamento sem compromisso
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={`https://wa.me/${whatsappNumber}`} className="text-muted-foreground hover:text-primary transition-colors">(44) 99999-9999</a>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    ...
                    <a href="mailto:contato@tecnicomaringa.com.br" className="text-muted-foreground hover:text-primary transition-colors">contato@tecnicomaringa.com.br</a>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 rounded-xl bg-primary/10 flex items-center justify-center flex-shrink-0">
            ...
            <div className="bg-gradient-to-br from-primary to-primary/80 rounded-2xl p-8 text-white">
              <h3 className="text-xl font-bold mb-4 font-heading">Prefere WhatsApp?</h3>
              <p className="text-white/90 mb-6">Atendimento rápido no {bairro}. Envie fotos do problema e receba orçamento imediato!</p>
              <Button variant="whatsapp" size="lg" className="w-full bg-white text-primary hover:bg-white/90" asChild>
                <a href={`https://wa.me/${whatsappNumber}?text=${encodeURIComponent(`Olá! Moro no ${bairro} e gostaria de solicitar um orçamento.`)}`} target="_blank" rel="noopener noreferrer">
                  Chamar no WhatsApp
                </a>
              </Button>
            </div>
          ...
          <div className="bg-card rounded-2xl p-8 shadow-card">
            <h3 className="text-xl font-bold text-foreground mb-6 font-heading">Formulário de Contato</h3>
            {isSuccess ? (
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="text-muted-foreground">Obrigado pelo contato do {bairro}. Responderemos em breve.</p>
              </div>
            ) : (
              <Form {...form}>
