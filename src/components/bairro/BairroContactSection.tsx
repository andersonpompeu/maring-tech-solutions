        ...
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <div className="bg-card rounded-2xl p-8 shadow-card border border-border/50">
              ...
              <div className="mt-8 bg-gradient-to-br from-primary to-accent rounded-xl p-6 text-white">
                ...
                <p className="text-white/90 text-sm mb-4">
                  Atendimento rápido no {bairro}. Envie fotos do problema e receba orçamento imediato!
                </p>
                <Button
                  variant="outline"
                  size="lg"
                ...
                >
                  <a
                    href={`https://wa.me/${whatsappNumber}?text=${encodeURIComponent(`Olá! Moro no ${bairro} e gostaria de solicitar um orçamento.`)}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    title={`Solicitar orçamento via WhatsApp no ${bairro}`}
                  >
          ...
          <div className="rounded-2xl overflow-hidden shadow-card border border-border/50 h-[400px]">
            <iframe
              ...
              title={`Localização Assistência Técnica no ${bairro} - Maringá`}
            />
          </div>
        </div>
      </div>
