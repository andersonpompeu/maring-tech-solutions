...
interface BairroTestimonialsSectionProps {
  bairro: string;
}

const testimonials = [
  { name: 'Maria Silva', rating: 5, text: 'Excelente serviço! Minha geladeira voltou a funcionar perfeitamente. Atendimento rápido e profissional. Recomendo!', service: 'Conserto de Geladeira', initials: 'MS' },
  { name: 'João Santos', rating: 5, text: 'Consertaram minha Smart TV em menos de 2 horas. Técnico muito educado e competente. Preço justo.', service: 'Reparo de Smart TV', initials: 'JS' },
  { name: 'Ana Oliveira', rating: 5, text: 'A tela do meu iPhone ficou nova! Trabalho impecável e garantia de 90 dias. Muito satisfeita!', service: 'Troca de Tela iPhone', initials: 'AO' },
  { name: 'Carlos Mendes', rating: 5, text: 'Minha máquina de lavar tinha um problema complexo, mas eles resolveram rapidamente. Ótimo custo-benefício.', service: 'Conserto de Lavadora', initials: 'CM' },
  { name: 'Fernanda Costa', rating: 5, text: 'Atendimento excepcional! Vieram buscar meu fogão e entregaram consertado no mesmo dia. Top!', service: 'Manutenção de Fogão', initials: 'FC' },
  { name: 'Roberto Lima', rating: 5, text: 'Serviço de primeira qualidade. Técnicos muito competentes e preço justo. Recomendo!', service: 'Conserto de Micro-ondas', initials: 'RL' },
];
...
const BairroTestimonialsSection = ({ bairro }: BairroTestimonialsSectionProps) => {
      ...
      <div className="container px-4 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-foreground mb-4">
            O Que Nossos Clientes do {bairro} Dizem
          </h2>
          <p className="text-muted-foreground text-lg">
            A satisfação dos nossos clientes no {bairro} é nossa maior conquista.
          </p>
        </div>
            ...
            >
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-border/50">
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground truncate">{bairro}, Maringá</p>
                </div>
...
export default BairroTestimonialsSection;
