...
const slides = [
  ...
  },
  {
    ...
    description: 'Todos os nossos serviços possuem garantia estendida. Sua satisfação é nossa prioridade.',
    icon: Shield,
    highlight: '90 Dias',
  },
  {
    ...
    description: 'Equipe técnica qualificada para resolver qualquer problema. Linha branca e eletrônicos.',
    icon: Clock,
    highlight: '10+ Anos',
  },
];
