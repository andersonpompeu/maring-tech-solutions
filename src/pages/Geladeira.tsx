...
const Geladeira = () => {
  ...
  return (
    <>
      <SEOHead
        title="Conserto de Geladeira em Maringá-PR"
        description="Conserto de geladeira em Maringá-PR. Frost Free, Duplex, Inverse e Side by Side. Peças originais, atendimento rápido e garantia."
        keywords="conserto geladeira Maringá, assistência técnica geladeira, conserto refrigerador, reparo geladeira perto de mim, técnico geladeira Maringá"
        canonical="https://assistenciatecnica.maringa.br/geladeira"
      />
