...
const heroServices = microondasServices;
...
const defectSigns = [
  'Micro-ondas não aquece os alimentos',
  'Painel ou teclado não responde',
  'Prato giratório não funciona',
  'Faíscas ou estalos durante o uso',
  'Barulhos estranhos ao ligar',
  'Porta não fecha ou trava corretamente',
  'Micro-ondas desliga sozinho',
  'Cheiro de queimado ao funcionar',
];
...
const faqs = [
  {
    question: 'Quanto custa o conserto de micro-ondas em Maringá?',
    answer: 'O preço para consertar um micro-ondas varia entre R$80,00 e R$450,00 conforme o defeito, a marca e as peças envolvidas. Oferecemos orçamento gratuito.',
  },
  {
    question: 'Vocês consertam micro-ondas Electrolux, Brastemp e Panasonic?',
    answer: 'Sim! Temos técnicos especializados nas principais marcas como Electrolux, Brastemp, Consul, Panasonic, Samsung, LG e Midea, com peças originais e garantia.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Sim! Em muitos casos conseguimos atender no mesmo dia, com técnicos próximos em diversas regiões de Maringá.',
  },
  {
    question: 'Quanto tempo demora o conserto de um micro-ondas?',
  ...
  {
    question: 'Vale a pena consertar um micro-ondas antigo?',
    answer: 'Na maioria dos casos, sim. O conserto costuma ser significativamente mais barato do que comprar um aparelho novo. Nossos técnicos avaliam e orientam sobre a melhor decisão.',
  },
];
  ...
  <section className="py-14 bg-gradient-hero text-primary-foreground relative overflow-hidden">
    ...
    <div className="container mx-auto px-4 relative text-center">
      <h2 className="text-2xl md:text-3xl font-heading font-bold mb-3">
        Conserto de Micro-ondas Perto de Mim
      </h2>
      <p className="text-primary-foreground/90 mb-6 max-w-2xl mx-auto">
        Micro-ondas não aquece, não liga ou com defeito? Resolvemos com <strong className="font-normal">atendimento rápido</strong> e garantia!
        ...
        <main>
          ...
          <div className="bg-muted/50 border-b border-border/50">
            <div className="container mx-auto px-4 py-3">
              <nav className="flex items-center gap-2 text-sm">
                ...
                <ChevronRight className="w-4 h-4 text-muted-foreground" />
                <span className="text-foreground font-medium">Micro-ondas</span>
              </nav>
            </div>
          </div>
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-3xl mx-auto text-center mb-14">
                <h2 className="text-2xl md:text-3xl font-heading font-bold text-foreground mb-4">
                  Assistência Técnica para Conserto de Micro-ondas em Maringá-PR
                </h2>
                <p className="text-muted-foreground text-lg leading-relaxed">
                  Quando você busca por "<strong>conserto de micro-ondas perto de mim</strong>" em <strong>Maringá</strong>, nós entregamos um serviço completo, com equipe experiente e atendimento rápido no melhor preço perto de você!
                </p>
              </div>
              ...
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-10">
                  ...
                  <h2 className="text-2xl md:text-3xl font-heading font-bold text-foreground mt-2">
                    Tipos de Micro-ondas que Consertamos
                  </h2>
                  <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
                    Atendemos residências, comércios e indústrias, com reparos técnicos para micro-ondas de diversos modelos, incluindo:
                  </p>
                </div>
          ...
          <section className="py-16 lg:py-20">
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
                ...
                <h2 className="text-2xl md:text-3xl font-heading font-bold text-foreground mt-2">
                  Vantagens de contratar uma Assistência Técnica de Micro-ondas perto de mim
                </h2>
              </div>
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-10">
                  ...
                  <h2 className="text-2xl md:text-3xl font-heading font-bold text-foreground mt-2">
                    Micro-ondas com defeito em Maringá? Veja os sinais
                  </h2>
                  <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
                    Problemas no micro-ondas podem ser causados por falhas no magnetron, placa eletrônica ou componentes desgastados.
                    Fique atento aos sintomas e evite riscos de segurança:
                  </p>
                </div>
              ...
              <div className="max-w-4xl mx-auto">
                <div className="bg-card rounded-3xl p-8 md:p-12 shadow-card border border-border/50">
                  <div className="text-center mb-8">
                    <h2 className="text-2xl md:text-3xl font-heading font-bold text-foreground mb-4">
                      Por que escolher Conserto de Micro-ondas Maringá?
                    </h2>
                    <p className="text-muted-foreground max-w-2xl mx-auto">
                      Precisando de conserto urgente? Nossa equipe de Conserto de Micro-ondas em Maringá atende rapidamente em casos emergenciais, com técnicos prontos para agir.
                    </p>
                  </div>
          ...
          <section className="py-14 bg-gradient-hero text-primary-foreground relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative text-center">
              ...
              <p className="text-primary-foreground/90 mb-6 max-w-2xl mx-auto">
                Micro-ondas não aquece, não liga ou com defeito? Resolvemos com atendimento rápido e garantia!
              </p>
