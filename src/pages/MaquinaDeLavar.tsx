...
const MaquinaDeLavar = () => {
  ...
  return (
    <>
      <SEOHead
        title="Conserto de Máquina de Lavar em Maringá-PR"
        description="Conserto de máquina de lavar em Maringá-PR. Lavadoras, lava e seca e secadoras. Peças originais e garantia de 90 dias."
        keywords="conserto máquina de lavar Maringá, assistência técnica lavadora, conserto lava e seca, reparo máquina de lavar perto de mim, técnico máquina de lavar Maringá"
        canonical="https://assistenciatecnica.maringa.br/maquina-de-lavar"
      />
