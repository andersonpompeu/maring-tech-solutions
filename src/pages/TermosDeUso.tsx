...
const TermosDeUso = () => {
  return (
    <>
      <SEOHead
        title="Termos de Uso | Assistência Técnica Maringá"
        description="Termos de Uso da Assistência Técnica Maringá. Conheça as condições para utilização dos nossos serviços de assistência técnica."
      />
