...
const TermosDeUso = () => {
  return (
    <>
      <Helmet>
        <title>Termos de Uso | TechFix Maringá</title>
        <meta name="description" content="Termos de Uso da TechFix Maringá. Conheça as condições para utilização dos nossos serviços de assistência técnica." />
      </Helmet>
          ...
          <div className="max-w-3xl mx-auto prose prose-lg">
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Ao utilizar os serviços da TechFix Maringá, você concorda com estes Termos de Uso. 
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                A TechFix Maringá oferece serviços de assistência técnica especializada em conserto e 
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Antes de iniciar qualquer reparo, a TechFix Maringá fornecerá um orçamento detalhado ao cliente. 
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Todos os serviços realizados pela TechFix Maringá possuem garantia de 90 (noventa) dias, 
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                A TechFix Maringá não se responsabiliza por dados armazenados em dispositivos deixados 
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                A TechFix Maringá reserva-se o direito de alterar estes Termos de Uso a qualquer momento. 
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                (44) 99999-9999 ou pelo e-mail contato@techfixmaringa.com.br.
              </p>
            </section>
          </div>
        </main>
