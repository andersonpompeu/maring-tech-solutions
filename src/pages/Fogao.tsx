...
import { fogaoServices } from '@/data/fogao-services';
...
const defectSigns = [
  ...
  'Chama amarela, fraca ou irregular',
  'Cheiro de gás mesmo com bocas fechadas',
  'Forno não aquece ou temperatura desregulada',
  'Acendimento automático não funciona',
  'Queimador apaga sozinho após soltar o botão',
  'Botões travados ou com dificuldade de girar',
  'Fogão esquenta excessivamente por fora',
];
...
const faqs = [
  {
    question: 'Quanto custa o conserto de fogão em Maringá?',
    answer: 'O preço para consertar um fogão varia entre R$80,00 à R$500,00 conforme o defeito, a marca e as peças envolvidas. Oferecemos orçamento gratuito na sua residência.',
  },
  {
    question: 'Vocês consertam fogões Brastemp, Electrolux e Atlas?',
    answer: 'Sim! Temos técnicos especializados nas principais marcas do mercado como Brastemp, Electrolux, Consul, Atlas, Dako, Mueller e Fischer, com peças originais e garantia.',
  },
  {
    question: 'Vocês realizam atendimento em domicílio?',
    answer: 'Sim, oferecemos atendimento técnico em domicílio em toda a região de Maringá. Nossa equipe vai até você com todos os equipamentos necessários.',
  },
  {
  ...
  {
    question: 'Vocês consertam cooktop e forno elétrico?',
    answer: 'Sim! Além de fogões convencionais, também reparamos cooktops (gás, elétrico e indução) e fornos elétricos embutidos de todas as marcas.',
  },
  {
  ...
  {
    question: 'É perigoso usar fogão com cheiro de gás?',
    answer: 'Sim, é extremamente perigoso! Se sentir cheiro de gás, feche o registro, abra portas e janelas e entre em contato imediatamente com nossa assistência técnica.',
  },
];
  ...
  <section className="py-14 bg-gradient-hero text-primary-foreground relative overflow-hidden">
    ...
    <div className="container mx-auto px-4 relative text-center">
      <h2 className="text-2xl md:text-3xl font-heading font-bold mb-3">
        Conserto de Fogão Perto de Mim
      </h2>
      <p className="text-primary-foreground/90 mb-6 max-w-2xl mx-auto">
        Fogão não acende, chama irregular ou forno com problema? Resolvemos com <strong className="font-normal">atendimento rápido</strong> e garantia!
...
const Fogao = () => {
  ...
  return (
    <>
      <SEOHead
        title="Conserto de Fogão em Maringá-PR"
        description="Conserto de fogão em Maringá-PR. Fogões a gás, cooktops, fornos elétricos e embutidos. Peças originais e garantia de 90 dias."
        keywords="conserto fogão Maringá, assistência técnica fogão, conserto cooktop, reparo forno, técnico fogão Maringá"
        canonical="https://assistenciatecnica.maringa.br/fogao"
      />
        ...
        <main>
          ...
          <div className="bg-muted/50 border-b border-border/50">
            <div className="container mx-auto px-4 py-3">
              <nav className="flex items-center gap-2 text-sm">
                ...
                <ChevronRight className="w-4 h-4 text-muted-foreground" />
                <span className="text-foreground font-medium">Fogão</span>
              </nav>
            </div>
          </div>
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-3xl mx-auto text-center mb-14">
                <h2 className="text-2xl md:text-3xl font-heading font-bold text-foreground mb-4">
                  Assistência Técnica para Conserto de Fogão em Maringá-PR
                </h2>
                <p className="text-muted-foreground text-lg leading-relaxed">
                  Quando você busca por "<strong>conserto de fogão perto de mim</strong>" em <strong>Maringá</strong>, nós entregamos um serviço completo, com equipe experiente e atendimento rápido no melhor preço perto de você!
                </p>
              </div>

              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {fogaoServices.map((service, index) => (
                  <article
                    key={index}
              ...
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-10">
                  ...
                  <h2 className="text-2xl md:text-3xl font-heading font-bold text-foreground mt-2">
                    Tipos de Fogão que Consertamos
                  </h2>
                  <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
                    Atendemos residências, comércios e indústrias, com reparos técnicos para fogões de diversos modelos, incluindo:
                  </p>
                </div>
          ...
          <section className="py-16 lg:py-20">
            <div className="container mx-auto px-4">
              <div className="text-center mb-12">
                ...
                <h2 className="text-2xl md:text-3xl font-heading font-bold text-foreground mt-2">
                  Vantagens de contratar uma Assistência Técnica de Fogões perto de mim
                </h2>
              </div>
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-4xl mx-auto">
                <div className="text-center mb-10">
                  ...
                  <h2 className="text-2xl md:text-3xl font-heading font-bold text-foreground mt-2">
                    Fogão com defeito em Maringá? Veja os sinais
                  </h2>
                  <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
                    Problemas no fogão podem ser causados por falhas no sistema de gás, ignição ou desgaste de peças.
                    Fique atento aos sintomas e evite riscos à segurança:
                  </p>
                </div>
              ...
              <div className="max-w-4xl mx-auto">
                <div className="bg-card rounded-3xl p-8 md:p-12 shadow-card border border-border/50">
                  <div className="text-center mb-8">
                    <h2 className="text-2xl md:text-3xl font-heading font-bold text-foreground mb-4">
                      Por que escolher Conserto de Fogão Maringá?
                    </h2>
                    <p className="text-muted-foreground max-w-2xl mx-auto">
                      Precisando de conserto urgente? Nossa equipe de Conserto de Fogão em Maringá atende rapidamente em casos emergenciais, com técnicos prontos para agir.
                    </p>
                  </div>
          ...
          <section className="py-14 bg-gradient-hero text-primary-foreground relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative text-center">
              ...
              <p className="text-primary-foreground/90 mb-6 max-w-2xl mx-auto">
                Fogão não acende, chama irregular ou forno com problema? Resolvemos com atendimento rápido e garantia!
              </p>
